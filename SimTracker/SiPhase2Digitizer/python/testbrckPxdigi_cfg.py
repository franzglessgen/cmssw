...
process = cms.Process("brckdigiTest")
...
process.MessageLogger = cms.Service("MessageLogger",
    debugModules = cms.untracked.vstring('BrickedDigisTest'),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('histo_1000.root')
)
...
process.analysis = cms.EDAnalyzer("BrickedDigisTest",
