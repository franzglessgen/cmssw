...
class ReadBrickedClusters : public edm::EDAnalyzer {
public:
  explicit ReadBrickedClusters(const edm::ParameterSet &conf);
  virtual ~ReadBrickedClusters();
...
/////////////////////////////////////////////////////////////////
// Contructor, empty.
ReadBrickedClusters::ReadBrickedClusters(edm::ParameterSet const &conf)
...
ReadBrickedClusters::~ReadBrickedClusters() {}

// ------------ method called at the begining   ------------
void ReadBrickedClusters::beginRun(edm::Run const &, const edm::EventSetup &iSetup) {
  cout << "beginRun -  PixelClusterTest " << printLocal << endl;
}

// ------------ method called at the begining   ------------
void ReadBrickedClusters::beginJob() {
...
void ReadBrickedClusters::endJob() {
...
void ReadBrickedClusters::analyze(const edm::Event &e, const edm::EventSetup &es) {
  using namespace edm;
...
DEFINE_FWK_MODULE(ReadBrickedClusters);
