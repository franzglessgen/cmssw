#ifndef __SimTracker_SiPhase2Digitizer_BrickedTBValidation_h
#define __SimTracker_SiPhase2Digitizer_BrickedTBValidation_h

// -*- C++ -*-
//
// Package:    SimTracker/SiPhase2Digitizer
// Class:      BrickedTBValidation
//
/**\class BrickedTBValidation BrickedTBValidation.cc
...
class BrickedTBValidation : public DQMEDAnalyzer {
public:
  explicit BrickedTBValidation(const edm::ParameterSet &);
  ~BrickedTBValidation() override;
