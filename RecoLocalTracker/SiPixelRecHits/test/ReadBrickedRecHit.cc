//--------------------------------------------
// File: ReadBrickedRecHit.cc
// Description:  see ReadBrickedRecHit.h
// Author:  J.Sheav (JHU)
...
#include "RecoLocalTracker/SiPixelRecHits/test/ReadBrickedRecHit.h"
...
//----------------------------------------------------------------------
ReadBrickedRecHit::ReadBrickedRecHit(edm::ParameterSet const& conf)
...
ReadBrickedRecHit::~ReadBrickedRecHit() {}
//---------------------------------------------------------------------
// ------------ method called at the begining   ------------
void ReadBrickedRecHit::beginJob() {
...
//-----------------------------------------------------------------------
void ReadBrickedRecHit::endJob() { cout << " End PixelRecHitTest " << endl; }
//---------------------------------------------------------------------
// Functions that gets called by framework every event
void ReadBrickedRecHit::analyze(const edm::Event& e, const edm::EventSetup& es) {
  using namespace edm;
...
DEFINE_FWK_MODULE(ReadBrickedRecHit);
