...
process.source = cms.Source("PoolSource",
    fileNames =  cms.untracked.vstring(
        ...
        'file:RecoHits_NB_10000.root'
	)
)

# Output
process.TFileService = cms.Service('TFileService',
    fileName = cms.string('file:rechit_NB_validation.root')
)
...
process.load('RecoLocalTracker.Phase2TrackerRecHits.Phase2BrickedRecHits_cfi')
process.analysis = cms.Sequence(process.siPhase2BrickedRecHits)
...
#se2TrackerValidateRecHit, Production Info
...
process.p = cms.Path(process.siPixelRecHits*process.analysis) 
