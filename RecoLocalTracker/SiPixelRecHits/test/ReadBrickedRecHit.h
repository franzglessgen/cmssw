#ifndef ReadBrickedRecHit_h
#define ReadBrickedRecHit_h

/** \class ReadBrickedRecHit
 *
 * ReadBrickedRecHit: Example of how to read Pixel RecHits
 *
...
class ReadBrickedRecHit : public edm::EDAnalyzer {
public:
  explicit ReadBrickedRecHit(const edm::ParameterSet &conf);

  virtual ~ReadBrickedRecHit();
